...
static int check_if_sorted(t_ps *stack_a)
{
    int i;
...
static void    push_back(t_ps *stack_a, t_ps *stack_b)
{
...
void two_stack_sort(t_ps *stack_a, t_ps *stack_b)
{
    ...
    {
        three_num_sort(stack_a, stack_a->array[0], stack_a->array[1], stack_a->array[2]);
        return ;
    }
    else
    {
